...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Add Customer Type</a></li>
          </ul>
        </li>
          ...
          <div class="box">
            ...
            <div id="all" class="tab-pane fade in active">
              <table id="all" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>Ajilore</td>
                  <td><a href="" class="btn-form-modal btn btn-warning glyphicon glyphicon-pencil"></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://ajiloreraphealolamsname.ng"> IHUB </a>.</strong> All rights
    reserved.
  </footer>
